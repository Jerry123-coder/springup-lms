...
async function CourseContent({
  ...
  return (
    <div className="flex flex-1 flex-col md:flex-row gap-4 md:gap-0">
      {/* Lesson sidebar */}
      <aside className="w-full shrink-0 rounded-xl border bg-card shadow-sm md:w-72 md:sticky md:top-4 md:self-start">
        <div className="border-b p-4">
          ...
          <h2 className="font-semibold text-lg">{typedCourse.title}</h2>
          ...
          <div className="rounded-xl border bg-card shadow-sm overflow-hidden">
            <div className="border-b bg-muted/30 px-6 py-5">
              ...
              <p className="mt-1 text-sm text-muted-foreground">
                Lesson {lessonList.findIndex((l) => l.id === activeLesson.id) + 1} of {lessonList.length}
              </p>
            </div>

            <div className="p-6 md:p-8">
              <div className="prose prose-sm prose-slate dark:prose-invert max-w-none text-foreground [&_h1]:text-xl [&_h1]:font-bold [&_h1]:mt-6 [&_h1]:mb-2 [&_h2]:text-lg [&_h2]:font-semibold [&_h2]:mt-4 [&_h2]:mb-1 [&_li]:ml-4 [&_blockquote]:border-l-2 [&_blockquote]:border-primary [&_blockquote]:pl-4 [&_blockquote]:italic [&_blockquote]:text-muted-foreground">
