...
export function HeroSection() {
  return (
    <section id="mission" className="relative -mt-16 flex min-h-screen flex-col overflow-hidden pt-16">
      {/* Background image */}
      <Image
      ...
      <div className="relative flex flex-1 flex-col justify-center px-4 pb-20 pt-6 sm:px-6 sm:pt-8 md:pb-24 md:pt-10 lg:pb-28 lg:pt-12">
        <div className="mx-auto w-full max-w-6xl">
          ...
          >
           Empowering Ghana’s young men at the Senior Correctional Centre (SCC), with digital skills and ethical leadership to turn a correctional stay into a career launchpad.  </p>

          <div
            className="mt-10 flex w-full flex-col gap-3 opacity-0 animate-fade-in-up sm:w-auto sm:flex-row"
          ...
          >
            ...
            <Button
              size="lg"
              variant="outline"
              className="w-full border-white/20 bg-white/5 text-base text-blue-100 transition-all duration-200 hover:scale-[1.02] hover:bg-white/10 hover:text-white active:scale-[0.98] sm:w-auto"
              asChild
            >
